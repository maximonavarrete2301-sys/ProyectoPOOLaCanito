...
public class ControladorEmpresas {
    ...
    public void hireConductorForEmpresa(Rut rutEmpresa, IdPersona id, Nombre nom, Direccion dir) {
        ...
        if (!ok) {
            throw new SVPException(
                    "Ya está contratado el conductor con el id indicado en la empresa señalada");
        }
    }
    public void hireAuxiliarForEmpresa(Rut rutEmpresa, IdPersona id, Nombre nom, Direccion dir) {
        ...
        if (!ok) {
            throw new SVPException(
                    "Ya está contratado el auxiliar con el id indicado en la empresa señalada");
        }
    }
...
public static void setInstanciaPersistente(
            ControladorEmpresas obj) {
